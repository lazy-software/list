...
export const ItemsScreen = forwardRef<HTMLInputElement, ItemsScreenProps>(
    function ItemsScreen({ activeList, onAddItem, onToggleItem }, ref) {
            ...
            <div className="p-4 pb-12 max-w-md mx-auto w-full">
                <form onSubmit={handleSubmit} className="mb-6">
                    <input
                        ...
                        aria-label={`Add item to ${activeList.name}`}
                        enterKeyHint="enter"
                            ...
                            >
                                ...
                                {item.snoozedUntil && (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 ml-2" viewBox="0 0 20 20" fill="currentColor">
                                        <title>Returned from snooze</title>
